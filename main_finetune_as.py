...
import models.AudioMAE.util.lr_decay as lrd
...
import models.AudioMAE.models_vit as models_vit
from models.AudioMAE.engine_finetune_as import train_one_epoch, evaluate #, train_one_epoch_av, evaluate_av
from models.AudioMAE.dataset_audioset import AudiosetDataset, DistributedWeightedSampler, DistributedSamplerWrapper
...
def main(args):
    ...
    if True: #args.distributed:
        ...
        print("DIST_EVAL", args.dist_eval)
        if args.dist_eval:
    ...
    print("DROP_PATH_RATE", args.drop_path)
    print("GLOBAL_POOL", args.global_pool)
    print("MASK_2D", args.mask_2d)
    print("USE_CUSTOM_PATCH", args.use_custom_patch)
    ...
    print("ADUIO_EXP", args.audio_exp)
    if args.audio_exp:
